...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "E:\\Node.js\\4-natours\\starter",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Uppdated Successfully"));
            }
...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.1113491, 34.111745],
    // zoom: 10,
    // interactive: false
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _userSettings.updateSettings)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _userSettings.updateSettings)({
